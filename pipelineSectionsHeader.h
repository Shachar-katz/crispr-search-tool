...
int findingKnownRepeats(string inputRead, string inputReadFileType, string inputCatalog, string outputFile, int seedK, int legitimateSpacer, int minK, string inputFileR2 = "");
